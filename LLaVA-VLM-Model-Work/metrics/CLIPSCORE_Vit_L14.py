...
print(f"\n[RESULT: BLIP_2 SM] Mean CLIPScore using ViT-L/14 ({MODEL_NAME}): {mean_score:.4f}")

with open(OUTPUT_FILE, "a", encoding="utf-8") as fout:
    fout.write(f"\n[RESULT: BLIP_2 SM] MEAN_SCORE\t{mean_score:.4f}\n")
